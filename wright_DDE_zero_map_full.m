function F_x = wright_DDE_zero_map_full(alpha, DDE_eigenvector_scaling, lambda, x)
%WRIGHT_DDE_ZERO_MAP - Evaluate the DDE zero finding problem for Wright's equation without truncation.
%
%   Syntax:
...
F_x = R_x*alpha + dotTerms + mtimes(x, R_x, 'Full')*alpha;
...
end % end wright_DDE_zero_map_full
